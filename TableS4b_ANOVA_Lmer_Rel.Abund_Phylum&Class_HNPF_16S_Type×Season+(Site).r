...
METADATA <- read.csv("aggregated.phylum.class.table.csv",header=T,row.names=1)
...
write.csv(Results.asterisk, "lmer.Rel.abund.phylum.class.Type×Season+(Site).HNPF.csv") 
