...
METADATA <- read.csv("aggregated.phylum.table.csv",header=T,row.names=1) #Change
...
write.csv(Results.asterisk, "lmer.Rel.abund.phylum.Type×Season+(1.Site).HNPF.csv") #Change
