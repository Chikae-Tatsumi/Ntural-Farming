...
saveRDS(se, paste("Network/SpiecEasi/top200/fungi/",NAME[i],".se.rds", sep=""))
...
write.csv(data, paste("Network/SpiecEasi/top200/fungi/",NAME[i],".metrics.csv", sep=""))
Results <- rbind (Results,data)
}
write.csv(Results, "Network/SpiecEasi/top200/fungi/all.metrics.csv")
