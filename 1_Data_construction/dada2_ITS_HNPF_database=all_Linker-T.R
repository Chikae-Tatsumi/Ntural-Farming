...
setwd("~/R/Analysis/4_Paddy/HNPF/ITS_database=all/withT")  ## CHANGE ME to the directory containing the fastq files.
...
setwd("~/R/Analysis/4_Paddy/HNPF/ITS_database=all")  ## CHANGE ME to the directory containing the fastq files.
filez <- list.files()
