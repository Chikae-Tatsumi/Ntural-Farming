...
# % table
ASV <- ASV.table [,1:(ncol(ASV.table)-7)] # I've changed 7--> 6
taxonomy <- ASV.table [,(ncol(ASV.table)-6):ncol(ASV.table)]  # I've changed 6--> 5
...
# scale_colour_gradient(low="",high="navy")+           # if you want to change the colors (gradient colors)
