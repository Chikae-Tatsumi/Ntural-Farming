...
ggsave(file = "Shannon.16s.png",width = 4, height = 2.5)
...
theme_classic()+
theme(text=element_text(size=16,color="black"),axis.text=element_text(size=14,color="black"))+
scale_y_continuous(name = "Fisher's diversity \n index")+
facet_wrap(~Site)
