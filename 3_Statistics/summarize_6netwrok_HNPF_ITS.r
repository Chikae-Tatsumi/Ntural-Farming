...
# Save 
dev.copy(pdf, file=paste("Network/Network.HNPF.ITS.",NAME[i],".pdf",sep=""), height=5, width=8)
dev.off()
dev.copy(png, file=paste("Network/Network.HNPF.ITS.",NAME[i],".png",sep=""), height=800, width=800)
dev.off()}
