...
METADATA <- read.csv("diversity.C.metabolism.csv",header=T,row.names=1) #Change
...
write.csv(Results.asterisk, "lm.diversity.C.metabolism.withEstimate.Type+Site+Season.HNPF.csv") #Change
...
DESIGN <- read.csv("experimental_design.csv")
setwd("~/R/Analysis/4_Paddy/HNPF/16S/Tax4Fun2")
METADATA <- read.csv("diversity.N.metabolism.csv",header=T,row.names=1) #Change
...
write.csv(Results.asterisk, "lm.diversity.N.metabolism.withEstimate.Type+Site+Season.HNPF.csv") #Change
